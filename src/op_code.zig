...
pub fn getOpCodeInfo(op_code: u8) OpCodeErrors!OpCodeInfo {
    ...
    return switch(op_code) {
        ...
        0x80 => OpCodeInfo.init(.ADD, .A, .B, 1, 4, .{ .Z = .Dependent, .N = .Reset, .H = .Dependent, .C = .Dependent }),
        0x81 => OpCodeInfo.init(.ADD, .A, .C, 1, 4, .{ .Z = .Dependent, .N = .Reset, .H = .Dependent, .C = .Dependent }),
        0x82 => OpCodeInfo.init(.ADD, .A, .D, 1, 4, .{ .Z = .Dependent, .N = .Reset, .H = .Dependent, .C = .Dependent }),
        0x83 => OpCodeInfo.init(.ADD, .A, .E, 1, 4, .{ .Z = .Dependent, .N = .Reset, .H = .Dependent, .C = .Dependent }),
        0x84 => OpCodeInfo.init(.ADD, .A, .H, 1, 4, .{ .Z = .Dependent, .N = .Reset, .H = .Dependent, .C = .Dependent }),
        0x85 => OpCodeInfo.init(.ADD, .A, .L, 1, 4, .{ .Z = .Dependent, .N = .Reset, .H = .Dependent, .C = .Dependent }),
        ...
        0xC6 => OpCodeInfo.init(.ADD, .A, .d8, 2, 8, .{ .Z = .Dependent, .N = .Reset, .H = .Dependent, .C = .Dependent}),
